...
async function verifyPurchase(message: Message, command: string[]) {
    ...
    if (command.length <= 1) {
        const commandEmbed = new MessageEmbed()
                ...
                .setAuthor('Credentials','https://cdn-icons-png.flaticon.com/512/84/84426.png?w=826&t=st=1656405386~exp=1656405986~hmac=870a4bd7400442a6cf5f130b2863cfd24690093cd75a2255713f6dbfaf87b279')
                .setDescription(`<@${message.author.id}> Please Enter Your email and Order Number e.g. ?verify-purchase user@memail.com 457345`)
                .setImage('https://cdn-icons-png.flaticon.com/512/84/84426.png?w=826&t=st=1656405386~exp=1656405986~hmac=870a4bd7400442a6cf5f130b2863cfd24690093cd75a2255713f6dbfaf87b279')
        ...
        if (command.length <= 1) {
            ...
            if (ValidateEmail(command[1])) {
                ...
                const commandEmbed = new MessageEmbed()
                    ...
                    .setAuthor('ERROR!','https://cdn-icons-png.flaticon.com/512/84/84426.png?w=826&t=st=1656405386~exp=1656405986~hmac=870a4bd7400442a6cf5f130b2863cfd24690093cd75a2255713f6dbfaf87b279')
                    .setImage('https://cdn-icons-png.flaticon.com/512/84/84426.png?w=826&t=st=1656405386~exp=1656405986~hmac=870a4bd7400442a6cf5f130b2863cfd24690093cd75a2255713f6dbfaf87b279')
                    .setTimestamp(new Date())
...
function getHelp(message: Message) {
    const commandEmbed = new MessageEmbed()
        ...
        .setAuthor('Whitelist','https://cdn-icons-png.flaticon.com/512/84/84426.png?w=826&t=st=1656405386~exp=1656405986~hmac=870a4bd7400442a6cf5f130b2863cfd24690093cd75a2255713f6dbfaf87b279')
